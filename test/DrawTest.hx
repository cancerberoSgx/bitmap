...
class DrawTest implements utest.ITest {
	...
	public function testdrawRectangle() {
		...
		a.draw.rectangle2(60, 20, 20, 40, Color.create(255, 44, 122, 132), true, {type: Blend.mean});
		a.draw.rectangle2(10, 20, 40, 22, Color.create(12, 144, 0, 132), false);
		BitmapIO.writeBitmap('test/assets/tmptestdrawRectangle.png', a);
	...
	public function testdrawLine() {
		...
		BitmapIO.writeBitmap('test/assets/tmptestdrawLine.png', a);
	...
	public function testdrawTriangle() {
		...
		a.draw.triangle(36, 92, 60, 22, 20, 10, Color.create(222, 144, 222, 111), true, {type: Blend.mean});
		BitmapIO.writeBitmap('test/assets/tmptestdrawTriangle.png', a);
