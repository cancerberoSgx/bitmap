...
class BitmapUtilTest implements utest.ITest {
	...
	public function testCompare() {
		...
		Assert.same(0, BitmapUtil.compare(a, b, {
				x: 0,
				y: 0,
				width: 2,
				height: 2
	...
	public function testMultiply() {
		var a = [[8.0, 3.0], [2.0, 4.0], [3.0, 6.0]], b = [[1.0, 2.0, 3.0], [4.0, 6.0, 8.0]];
	...
	public function testBase64DataUrl() {
		var b = PNGBitmap.create(IOUtil.readFile("test/assets/small.png"));
		var u = BitmapUtil.toDataUrl(b);
		Assert.equals(u,
			"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAGCAYAAADgzO9IAAAAIElEQVR42mO4d+9eCzr+DwQMMA7PBAYwpoIEhh3/cQAAZWptzxLe8wIAAAAASUVORK5CYII=");

		var b2 = BitmapUtil.fromDataUrl(u);
		Assert.isTrue(BitmapUtil.bitmapEquals(b, b2));

		b = PNGBitmap.create(IOUtil.readFile("test/assets/small.png"));
		b.set(1, 1, Color.create(255, 0, 0, 222));
		Assert.equals(BitmapUtil.toDataUrl(b),
			"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAGCAYAAADgzO9IAAAAKElEQVR42mO4d+9eCzr+DwQMYAYDwz2eCQwtIIwiAcKkS2DY8R8HAADQb2yOj6UYOAAAAABJRU5ErkJggg==");

		b2 = BitmapUtil.fromDataUrl(BitmapUtil.toDataUrl(b));
		Assert.isTrue(BitmapUtil.bitmapEquals(b, b2));
	}
}
